...
app.post("/api/message/media/:category", (req, res) => {
  ...
  bb.on("finish", async () => {
    ...
    link =
      "https://ec2-18-219-92-27.us-east-2.compute.amazonaws.com/api/temp/media/document_0192ee8e-d5e2-7227-8e47-ae9ec504c6e0_0192ee8e-d5e2-7227-8e47-b6875ecf5c66";

...
El horario de atención para un asistente humano es de 8:00 am a 1:00 pm y de 3:00pm a 6:30 pm, los feriados solo hasta el medio dia`;
      const mensajeAsistente =
        'Tu eres un asistente virtual en español, ofrece servicios al cliente,si el cliente no pregunta nada en especifico sobre la empresa no respondas y siempre dale la lista de planes disponibles y ofrece, la info que necesitas de la empresa es: "' +
        info;

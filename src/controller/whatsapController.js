...
El horario de atención para un asistente humano es de 8:00 am a 1:00 pm y de 3:00pm a 6:30 pm, los feriados solo hasta el medio dia`;
      const mensaje =
        'responde el siguiente mensaje hecho por un cliente,  se breve y responde de forma corta y directa, ten en cuenta que no tienes memoria de mensajes anteriores asi que no hagas preguntas que el cliente responda y que luego no sepas de que trata,ademas si el mensaje no esta dirigido a informacion de la empresa, niega la orden y cuando el cliente menciona planes se refiere a planes de internet, ademas si se interesa por un plan enfocate en ese plan: "' +
        msg_body +
